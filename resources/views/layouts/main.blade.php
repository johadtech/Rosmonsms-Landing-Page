...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<link rel="stylesheet" href="/template/assets/css/ud-styles.css?v={{ time() }}" />
	...
	<body style="font-size:0.8em;">
		...
		<div class="whatsapp-cta-container left">
			<a href="{{ gs()->whatsapp_support }}" target="_blank" class="whatsapp-icon whatsapp-icon--left">
			    <i class="lni lni-whatsapp"></i>
			</a>
			{{--<strong style="position: fixed;z-index: 999;text-align: center;left: 20px;top: 76%;color: #000000;">Support</strong>--}}
		</div>
		<div class="whatsapp-cta-container right d-none">
			<a href="{{ gs()->whatsapp_support }}" target="_blank" class="whatsapp-icon whatsapp-icon--right">
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="ud-widget">
								...
								<p class="ud-widget-desc">
									{{ front_setting('footer_description') }}
								</p>
								<ul class="ud-widget-socials">
									<li>
										<a href="{{ gs()->social_facebook }}">
											<i class="lni lni-facebook-filled"></i>
										</a>
									</li>
									<li>
										<a href="{{ gs()->social_twitter }}">
											<i class="lni lni-twitter-filled"></i>
										</a>
									</li>
									<li>
										<a href="{{ gs()->social_instagram }}">
						...
						<div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
							<div class="ud-widget">
								<h5 class="ud-widget-title">{{ __('Quick link') }}</h5>
						...
						<div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
							<div class="ud-widget">
								<h5 class="ud-widget-title">{{ __('Our Company') }}</h5>
								<ul class="ud-widget-links">
									<li>
									...
									<li>
										<a href="{{route('termcondition')}}">Terms of service</a>
									</li>
									<li>
						...
						<div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
							<div class="ud-widget">
								<h5 class="ud-widget-title">{{ __('Our Products') }}</h5>
								<ul class="ud-widget-links">
									<li>
						...
						<div class="col-xl-3 col-lg-6 col-md-8 col-sm-10">
							<div class="ud-widget">
								<h5 class="ud-widget-title">{{ __('Partners') }}</h5>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<p class="ud-footer-bottom-right">
								© <script>document.write(new Date().getFullYear())</script> {{ gs()->site_name }}.
							</p>
						</div>
					</div>
				</div>
		...
		<script type="text/javascript">
			...
			(function() {
			    ...
			    s1.async = true;
			    s1.src = 'https://embed.tawk.to/{{ gs()->tawk_widget_id }}/{{ gs()->tawk_property_id }}';
			    s1.charset = 'UTF-8';
		...
		<script>
			window.addEventListener('scroll', function () {
			    ...
			    if (ud_header.classList.contains("sticky")) {
			        logo.src = "{{ asset('storage/general/'.gs()->logo) }}";
			    } else {
			        logo.src = "{{ asset('storage/general/'.gs()->logo) }}";
			    }
			});
