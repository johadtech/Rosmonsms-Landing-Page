				...
				<div class="card">
					...
					<div class="card-body pt--1">
						...
						<div class="container">
							...
							<h5 class="mb-3 text-center small">Create Category</h5>
								...
								<div class="row mb-5">
									...
									<div class="col-sm-6">
										<div class="input-group mb-3">
											...
											<div class="input-group">
												<input type="text" class="form-control form-control-sm" id="pc-clipboard-1" placeholder="Categories slug" readonly value="https://website.com">
									...
									<div class="col-sm-6">
										<div class="mb-3">
											...
											<input type="text" class="form-control form-control-sm" placeholder="Category name" id="name" name="name" required>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="mb-3">
											...
											<textarea class="form-control form-control-sm mb-2" rows="6" id="description" name="description" required> </textarea>
										</div>
									</div>
