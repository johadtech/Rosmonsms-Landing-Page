			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header d-none">
						<h5 class="mb-0 text-center small">Edit FAQ</h5>
					</div>
					<div class="card-body pt--1">

						<div class="container">
							
							<h5 class="mb-3 text-center small">Edit FAQ</h5>
							
							<form id="myForm" action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" enctype="multipart/form-data">
								@csrf
								@method('PUT')
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control form-control-sm" id="title" placeholder="Title" name="title" value="{{ $faq->title }}" required>
										</div>
									</div>
...
<!-- Initialize Quill editor -->
  <script type="text/javascript">
    (function () {
      ...
      //var content = `{!! htmlspecialchars(old('content') ? old('content') : $faq->content) !!}`;
      //quill.clipboard.dangerouslyPasteHTML(content);
      
      const parser = new DOMParser();
      const doc = parser.parseFromString(`{!! $faq->content !!}`, 'text/html');
