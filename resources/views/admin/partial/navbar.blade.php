		...
		<div class="navbar-content">
			...
			<ul class="pc-navbar">
			    ...
			    <li class="pc-item pc-hasmenu">
			        ...
			        <ul class="pc-submenu">
			            <li class="pc-item">
			                <a href="{{ route('admin.team-members.index') }}" class="pc-link">List Team</a>
			            </li>
			            <li class="pc-item">
			                <a href="{{ route('admin.team-members.create') }}" class="pc-link">Create Team</a>
			            </li>
			        </ul>
			    </li>
			    ...
			    <li class="pc-item pc-hasmenu">
			        ...
			        <ul class="pc-submenu">
			            <li class="pc-item">
			                <a href="{{ route('admin.faqs.index') }}" class="pc-link">List Faqs</a>
			            </li>
			            <li class="pc-item">
			                <a href="{{ route('admin.faqs.create') }}" class="pc-link">Create Faqs</a>
			            </li>
			        </ul>
			    </li>
