				...
				<div class="col-lg-12">
					<div class="ud-hero-content wow fadeInUp" data-wow-delay=".2s">
						...
						<ul class="ud-hero-buttons">
							<li>
								<a href="{{ route('bookdemo') }}" rel="nofollow noopener" target="_blank" class="ud-main-btn ud-white-btn">
									{{ __(front_setting('hero_button_one')) }}
								</a>
							</li>
							<li>
								<a href="#about" rel="nofollow noopener" target="_blank" class="ud-main-btn ud-link-btn" style="border: 2px solid #fff;">
								    {{ __(front_setting('hero_button_two')) }} <i class="lni lni-arrow-right"></i>
								</a>
							</li>
						</ul>
					</div>
					...
					<div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
						...
						<img src="{{ asset('storage/hero/' . front_setting('hero_image')) }}" alt="hero-image" />
