						...
						<div class="container">
							...
							<form id="myForm" action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
								...
								<div class="dropzone mb-3">
									...
									<div class="fallback">
										<input name="thumbnail" type="file" required accept="image/jpeg,image/png,image/jpg" class="form-control form-control-sm" value="{{ asset('storage/post/'.$post->thumbnail) }}">
									</div>
								</div>
