...
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
	...
	<?php echo $__env->make('pages.partial.hero', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="ud-section-title">
						...
						<h2>Why use <?php echo e(__(gs()->site_name)); ?></h2>
						<p>
					...
					<div class="ud-single-feature wow fadeInUp" data-wow-delay=".1s">
						...
						<div class="ud-feature-content">
							...
							<p class="ud-feature-desc">
								Customize <?php echo e(__(gs()->site_name)); ?> to suit your unique school needs, curriculum and pedagogy seamlessly.
							</p>
				...
				<div class="col-xl-3 col-lg-3 col-sm-6">
					<div class="ud-single-feature wow fadeInUp" data-wow-delay=".15s">
						...
						<div class="ud-feature-content">
							...
							<p class="ud-feature-desc">
								Our customer care representatives are ever ready to assist you and your school through an exciting <?php echo e(__(gs()->site_name)); ?> journey.
							</p>
							<a href="javascript:void(0)" class="ud-feature-link">
							</a>
						</div>
				...
				<div class="col-xl-3 col-lg-3 col-sm-6">
					<div class="ud-single-feature wow fadeInUp" data-wow-delay=".2s">
						...
						<div class="ud-feature-content">
							...
							<p class="ud-feature-desc">
								<?php echo e(__(gs()->site_name)); ?> uses AI to deliver an innovative product that solves all your school needs.
							</p>
							<a href="javascript:void(0)" class="ud-feature-link">
							</a>
						</div>
				...
				<div class="info-section">
					<div class="info-content">
				        <div class="video-content">
				            <video controls>
				                <source src="<?php echo e(asset('storage/general/'.front_setting('below_hero_video'))); ?>" type="video/mp4">
				                <?php echo e(__('Your browser does not support the video tag.')); ?>

				            </video>
				        </div>
				        <div class="text-content">
				            <h2><?php echo e(__(front_setting('below_hero_heading'))); ?></h2>
				            <p><?php echo e(__(front_setting('below_hero_description'))); ?></p>
				        </div>
				    </div>
				</div>
			</div>
			...
			<div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
				<div class="ud-about-content-wrapper">
					<div class="ud-about-content">
						...
						<h2><?php echo e(__(front_setting('home_about_heading'))); ?></h2>
						<p>
							<?php echo e(__(front_setting('home_about_description_one'))); ?>

						</p>

						<p>
							<?php echo e(__(front_setting('home_about_description_two'))); ?>

						</p>
						<a href="/about-us" class="ud-main-btn"><?php echo e(__(front_setting('home_about_button'))); ?></a>
					</div>
				</div>
				<div class="ud-about-image">
					<img src="<?php echo e(asset('storage/general/'.front_setting('home_about_image'))); ?>" alt="about-image" />
				</div>
			</div>
		</div>
	</section>
	...
	<section id="faq" class="ud-faq">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="ud-section-title text-center mx-auto">
						<span>FAQ</span>
						<h2><?php echo e(__(front_setting('home_faq_heading'))); ?></h2>
						<p>
							<?php echo e(__(front_setting('home_faq_description'))); ?>
			...
			<div class="row">
				<div class="col-lg-6">
					<?php $__currentLoopData = \App\Models\Faq::where('status', 1)->take(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="col-lg-6">
					<?php $__currentLoopData = \App\Models\Faq::where('status', 1)->skip(3)->take(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="ud-single-faq wow fadeInUp" data-wow-delay=".1s">
						<div class="accordion">
							<button
								class="ud-faq-btn collapsed"
	...
	<section id="testimonials" class="ud-testimonials">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="ud-section-title mx-auto text-center">
						...
						<h2><?php echo e(__(front_setting('home_testimony_heading'))); ?></h2>
						<p>
							<?php echo e(__(front_setting('home_testimony_description'))); ?>
			...
			<div class="row">
				<?php $__currentLoopData = App\Models\Testimony::active()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".1s">
						...
						<div class="ud-testimonial-info">
							<div class="ud-testimonial-image">
								<img src="<?php echo e(generate_avater($item->full_name)); ?>" alt="author" />
							</div>
							<div class="ud-testimonial-meta">
								<h4><?php echo e($item->full_name); ?></h4>
								<p>
									<?php echo e($item->occupation); ?>
				...
				<div class="col-xl-8 col-lg-7">
					<div class="ud-contact-content-wrapper">
						<div class="ud-contact-title">
							...
							<h2>
								<?php echo e(__(front_setting('home_contact_text'))); ?>
						...
						<div class="ud-contact-info-wrapper">
							...
							<div class="ud-single-info">
								...
								<div class="ud-info-meta">
									...
									<p>
										<a href="tel:<?php echo e(gs()->site_mobile); ?>" class="read-more"><?php echo e(gs()->site_mobile); ?></a>
									</p>
									<p>
										<a href="mailto:<?php echo e(gs()->site_email); ?>" class="read-more"><?php echo e(gs()->site_email); ?></a>
									</p>
								</div>
							</div>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosmonsm/test.rosmonsms.com/resources/views/pages/index.blade.php ENDPATH**/ ?>