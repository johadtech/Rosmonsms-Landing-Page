		...
		<div class="row align-items-center">
			<div class="col-xl-8 col-lg-7">
				<div class="ud-contact-content-wrapper">
					<div class="ud-contact-title">
						...
						<h2>
							<?php echo e(__(front_setting('contact_us_text'))); ?>
            ...
            <div class="col-xl-4 col-lg-5 mb-3">
                <div class="ud-map-wrapper wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="ud-map">
                        <iframe src="<?php echo e(gs()->map_url); ?>" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy">
                        </iframe>
                    </div>
                </div>
            </div>
		...
		<div class="row justify-content-center">
			<div class="col-12 text-center">
				<div class="section-title">
					...
					<div class="mt-4">
						<a href="<?php echo e(route('bookdemo')); ?>" class="btn btn-primary mt-2 me-2">Get Started Now</a>
						<a href="<?php echo e(url('/')); ?>" class="btn btn-outline-primary mt-2">Home</a>
					</div>
				</div>
			</div>
			<!--end col-->
...
<!-- End Privacy -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosmonsm/test.rosmonsms.com/resources/views/pages/contact.blade.php ENDPATH**/ ?>