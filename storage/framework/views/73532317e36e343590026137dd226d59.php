				...
				<div class="card">
					...
					<div class="card-body pt--1">
						...
						<div class="container mb-5">
							...
							<form id="myForm1" action="<?php echo e(route('admin.scripts.header.update', 1)); ?>" method="POST">
								<?php echo csrf_field(); ?>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-6">
										<div class="mb-3 code-editor">
											...
											<textarea class="form-control form-control-sm mb-2 small language-markup" rows="8" id="script" name="script" required> <?php echo e($headscript->script); ?> </textarea>
										</div>
									</div>
						...
						<div class="container mt-3">
							...
							<form id="myForm2" action="<?php echo e(route('admin.scripts.footer.update', 1)); ?>" method="POST">
								<?php echo csrf_field(); ?>
								<?php echo method_field('PUT'); ?>
								<div class="row mb-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosmonsm/test.rosmonsms.com/resources/views/admin/scripts/index.blade.php ENDPATH**/ ?>