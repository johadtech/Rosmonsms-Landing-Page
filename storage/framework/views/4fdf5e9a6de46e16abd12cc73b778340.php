      ...
      <div class="container">
        <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
          ...
          <div class="ud-about-image">
            <img src="<?php echo e(asset('storage/general/' . front_setting('privacy_and_policy_image'))); ?>"  alt="about-image" />
          </div>
        </div>
      </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosmonsm/public_html/resources/views/pages/privacy-and-policy.blade.php ENDPATH**/ ?>