			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header d-none">
						<h5 class="mb-0 text-center small">Create FAQ</h5>
					</div>
					<div class="card-body pt--1">

						<div class="container">
							
							<h5 class="mb-3 text-center small">Create FAQ</h5>
							
							<form id="myForm" action="<?php echo e(route('admin.faqs.store')); ?>" method="POST" enctype="multipart/form-data">
								<?php echo csrf_field(); ?>
								<div class="row">
...
<!-- Initialize Quill editor -->
  <script type="text/javascript">
    (function () {
      ...
      //var content = `<?php echo htmlspecialchars(old('content') ? old('content') : ''); ?>`;
      //quill.clipboard.dangerouslyPasteHTML(content);
      
      const parser = new DOMParser();
      const doc = parser.parseFromString(`<?php echo old('content') ? old('content') : ''; ?>`, 'text/html');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosmonsm/test.rosmonsms.com/resources/views/admin/faqs/create.blade.php ENDPATH**/ ?>