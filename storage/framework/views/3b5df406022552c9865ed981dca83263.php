				...
				<div class="card">
					...
					<div class="card-body pt--1">
						...
						<div class="container">
							...
							<h5 class="mb-3 text-center small">Create Post</h5>
							
							<form id="myForm" action="<?php echo e(route('admin.posts.store')); ?>" method="POST" enctype="multipart/form-data">
								<?php echo csrf_field(); ?>
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="input-group mb-3">
											...
											<div class="input-group">
												<input type="text" class="form-control form-control-sm" id="pc-clipboard-1" placeholder="Post slug" readonly value="https://website.com">
									...
									<div class="col-sm-6">
										<div class="mb-3">
											...
											<input type="text" class="form-control form-control-sm" id="" placeholder="Post title" name="title" required>
										</div>
									</div>
								...
								<div class="mb-3">
									...
									<textarea class="form-control form-control-sm mb-2" id="" rows="6" name="description" required> </textarea>
								</div>
								...
								<div class="dropzone mb-3">
									...
									<div class="fallback">
										<input name="thumbnail" type="file" required accept="image/jpeg,image/png,image/jpg" class="form-control form-control-sm">
									</div>
								</div>
								
								<div class="mb-3">
									<label class="form-label">Tags</label>
									<input type="text" class="form-control form-control-sm" id="" name="tags" placeholder="Post tags">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosmonsm/test.rosmonsms.com/resources/views/admin/posts/create.blade.php ENDPATH**/ ?>